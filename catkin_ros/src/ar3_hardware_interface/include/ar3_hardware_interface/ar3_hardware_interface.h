//jcheng2020 revised version for joint manually adjustment, include #include <boost/scoped_ptr.hpp>   
...
namespace ar3_hardware_interface
{
	class AR3HardwareInterface: public hardware_interface::RobotHW
	{
		...
		private:
			...
			ros::Subscriber sub;
			static void deviation_callback(const std_msgs::String::ConstPtr& msg);
			//for the mannually joint angle adjustment
			static double joint_deviation_adjustment[6];
