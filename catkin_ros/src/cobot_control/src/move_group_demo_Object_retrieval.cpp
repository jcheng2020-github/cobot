//<description>MoveIt script for object retrieval P&P operation, required to cooperate with tf broadcaster from kinect v2 camera dodo_detector data</description>
...
void pick(moveit::planning_interface::MoveGroupInterface& move_group)
{
  ...
  grasps[0].grasp_pose.pose.position.z = object_z+deviation_z + 0.044;
