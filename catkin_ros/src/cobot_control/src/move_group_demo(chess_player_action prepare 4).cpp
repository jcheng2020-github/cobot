//<description>MoveIt script for chess_player_motion_series test MOVEIT P&P SOLUTION TEST</description>
...
double tfX_begin[8] = {tfXOrigin_end ,
	         0.115,
...
double tfX_end[8] = {tfXOrigin_end/*0.160*/,
	         tfXOrigin_end - dX1_end ,
		 tfXOrigin_end - dX1_end *2 , 
		 tfXOrigin_end - dX1_end *3, 
		 tfXOrigin_end - dX1_end *4,
		 tfXOrigin_end - dX1_end *5,
		 tfXOrigin_end - dX1_end *6,
		 tfXOrigin_end - dX1_end *7};
double tfY_end[8] = {-0.201/*-0.210*/ ,
		 -0.201 - dY1_end,
		 tfYOrigin_end - dY1_end *2,
		 tfYOrigin_end - dY1_end *3, 
		 tfYOrigin_end - dY1_end *4, 
		 tfYOrigin_end - dY1_end *5,
		 tfYOrigin_end - dY1_end *6,
		 tfYOrigin_end - dY1_end *7};
...
void uci2tf(std::string uci)
{
	...
	end_x = tfX_end[endTfPosReferenceX];
	end_y = tfY_end[endTfPosReferenceY];
}
