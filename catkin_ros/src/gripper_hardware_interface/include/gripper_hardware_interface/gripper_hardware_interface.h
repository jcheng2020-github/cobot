...
#ifndef GRIPPER_HARDWARE_INTERFACE_H
#define GRIPPER_HARDWARE_INTERFACE_H
...
{
	class GRIPPERHardwareInterface: public hardware_interface::RobotHW
	{
		public:
			GRIPPERHardwareInterface(ros::NodeHandle& nh);
		...
		private:
			...
			// Motor driver
			gripper_hardware_drivers::GripperDriver driver_;
...
#endif // GRIPPER_HARDWARE_INTERFACE_H
