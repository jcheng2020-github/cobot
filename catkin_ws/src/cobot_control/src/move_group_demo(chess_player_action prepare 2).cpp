//<description>MoveIt script for chess_player_motion_series chess_player_action prepare 2 test</description>
...
double object_x = -0.20, object_y = -0.18 , object_z = 0.046 ;
double detected_x = -0.4, detected_y = -0.65 , detected_z = 0.046;
double deviation_x = 0.0 ,deviation_y = -0.0, deviation_z = 0.0;

double end_x =  0, end_y =-0.45;
...
void pick(moveit::planning_interface::MoveGroupInterface& move_group)
{
  ...
  */
  //verticle pick
  grasps[0].grasp_pose.pose.position.x = object_x+deviation_x;
  grasps[0].grasp_pose.pose.position.y = object_y+deviation_y;
  grasps[0].grasp_pose.pose.position.z = object_z+deviation_z + 0.255;
...
void place(moveit::planning_interface::MoveGroupInterface& group)
{
  ...
  place_location[0].place_pose.pose.position.z = object_z+deviation_z;
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
  ...
  collision_objects[0].primitive_poses[0].position.x = object_x+deviation_x;
  collision_objects[0].primitive_poses[0].position.y = object_y+deviation_y;
  ...
  collision_objects[2].primitive_poses[0].position.x = object_x+deviation_x;
  collision_objects[2].primitive_poses[0].position.y = object_y+deviation_y;
  collision_objects[2].primitive_poses[0].position.z = object_z+deviation_z;
