...
void pick(moveit::planning_interface::MoveGroupInterface& move_group)
{
  ...
  grasps[0].grasp_pose.pose.position.x = -0.30;
...
void place(moveit::planning_interface::MoveGroupInterface& group)
{
  ...
  place_location[0].place_pose.pose.position.y = -0.50;
  ...
  place_location[0].pre_place_approach.desired_distance = 0.010;
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
  ...
  collision_objects[1].primitive_poses[0].position.y = -0.47;
  ...
  collision_objects[2].primitive_poses[0].position.x = -0.52;
  collision_objects[2].primitive_poses[0].position.y = 0;
  collision_objects[2].primitive_poses[0].position.z = 0.20;
