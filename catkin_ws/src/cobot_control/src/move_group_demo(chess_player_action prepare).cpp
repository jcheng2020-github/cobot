//<description>MoveIt script for ready and retrieval motion test for chess_player_motion_series test</description>
...
int main(int argc, char** argv)
{
  ...
  static const std::string PLANNING_GROUP = "ar3";
