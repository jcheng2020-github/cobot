...
//TeensyDriver( ros node publish communicate version)  
...
class TeensyDriver {
  public:
    ...
    TeensyDriver(ros::NodeHandle& nh);
  ...
  private:
    ...
    ros::NodeHandle n;
    ros::Publisher teensyDriver_pub;
    ros::Subscriber sub;

    static void teensyCallback(const std_msgs::String::ConstPtr& msg);
    static bool whetherCallback;
    static std::string buffer;
};

} // namespace ar3_hardware_drivers

bool ar3_hardware_drivers::TeensyDriver::whetherCallback;
std::string ar3_hardware_drivers::TeensyDriver::buffer;
